...
import com.fisc.decljeuxhasard.DecljeuxhasardApp;
...
@SpringBootTest(classes = DecljeuxhasardApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecljeuxhasardKafkaResourceIT {
    ...
    @Autowired
    private DecljeuxhasardKafkaProducer producer;

    @Autowired
    private DecljeuxhasardKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecljeuxhasardKafkaResource kafkaResource = new DecljeuxhasardKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decljeuxhasard-kafka/publish?message=test"))
