package com.fisc.decljeuxhasard.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("decljeuxhasard");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("decljeuxhasard");
        ...
        config.getMapConfigs().put("com.fisc.decljeuxhasard.domain.*", initializeDomainMapConfig(jHipsterProperties));
